...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:ThirdPartyNewsRoomMessage/Attribute:priority+' => 'Priority. 1 = lowest, 4 = highest.',
	'Class:ThirdPartyNewsRoomMessage/Attribute:priority/Value:1' => '1 (lowest)',
	'Class:ThirdPartyNewsRoomMessage/Attribute:priority/Value:2' => '2',
	'Class:ThirdPartyNewsRoomMessage/Attribute:priority/Value:3' => '3',
	'Class:ThirdPartyNewsRoomMessage/Attribute:priority/Value:4' => '4 (highest)',
	...
	'Class:ThirdPartyNewsRoomMessage/Attribute:target_profiles' => 'Target profiles (deprecated)',
	...
	'Class:ThirdPartyNewsRoomMessage/Attribute:manually_created' => 'Is source',
	'Class:ThirdPartyNewsRoomMessage/Attribute:manually_created+' => 'Whether or not the message is the original source message (and should not be deleted by the background task).',
	'Class:ThirdPartyNewsRoomMessage/Attribute:manually_created/Value:yes' => 'Yes',
	'Class:ThirdPartyNewsRoomMessage/Attribute:manually_created/Value:no' => 'No',
