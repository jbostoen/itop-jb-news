...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:ThirdPartyNewsMessage/Attribute:target_profiles' => 'Target profiles (deprecated)',
	'Class:ThirdPartyNewsMessage/Attribute:target_profiles+' => 'Profiles which will see this message. If empty, every user profile will see this message.',
	'Class:ThirdPartyNewsMessage/Attribute:oql' => 'OQL',
	'Class:ThirdPartyNewsMessage/Attribute:oql+' => 'The OQL which specifies which users should see this message.',
